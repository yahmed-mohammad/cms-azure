...
class Config(object):
    ...
    BLOB_STORAGE_KEY = os.environ.get('BLOB_STORAGE_KEY') or 'azurecmsstorage'
    ...
    CLIENT_SECRET = "2ddda2c9-72f8-4787-b948-c156c6b3e794"
    ...
    CLIENT_ID = "ab7103c6-f5e8-4114-bb5a-3c4a31b9728e"
